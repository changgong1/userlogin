...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fhelloworld_2eproto = {
  false, false, descriptor_table_protodef_proto_2fhelloworld_2eproto, "proto/helloworld.proto", 180,
...
static bool dynamic_init_dummy_proto_2fhelloworld_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fhelloworld_2eproto)), true);
namespace helloworld {
